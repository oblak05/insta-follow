    ...
    def __init__(self):
        ...
        try:
            ...
            if ':' in str(self.ACCOUNTS):
                ...
                printf(Panel(f"[bold white]Please fill in your Instagram account username, make sure the account is not locked and the\nusername is correct. Example:[bold gray]@akhirro_qxzi", width=59, style="bold bright_black", title="[bold bright_black][Target's Username]", subtitle="[bold bright_black]╭──────", subtitle_align="left"))
...
[bold white](_____)_| |_(___/ \___)_||_|_||_||_|\___/ \____|\_||_|
        [underline green]Instagram Followers Tool - [bold blue]by Gueverro""", width=59, style="bold bright_black"))
        return (True)
